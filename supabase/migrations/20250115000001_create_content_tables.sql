...
CREATE TABLE IF NOT EXISTS site_settings (
  ...
  company_name TEXT NOT NULL DEFAULT 'BuildMaster İnşaat',
  ...
  address TEXT NOT NULL DEFAULT '123 BuildMaster Cad., İnşaat Mahallesi, İstanbul 34000',
  phone TEXT NOT NULL DEFAULT '(0212) 456-7890',
  email TEXT NOT NULL DEFAULT 'info@buildmaster.com',
  ...
  hero_subtitle TEXT NOT NULL DEFAULT 'Ücretsiz danışmanlık için bugün bizimle iletişime geçin ve BuildMaster''ın vizyonunuzu nasıl hayata geçirebileceğini keşfedin.',
  about_title TEXT NOT NULL DEFAULT 'BuildMaster Hakkında',
...
VALUES (
  ...
  '123 BuildMaster Cad., İnşaat Mahallesi, İstanbul 34000',
  '(0212) 456-7890',
...
('BuildMaster''ı diğer inşaat şirketlerinden ayıran nedir?', 'BuildMaster, kaliteye bağlılığımız, şeffaf iletişimimiz, yenilikçi çözümlerimiz ve zamanında teslimatımızla öne çıkıyor. Geleneksel ustalığı modern teknolojilerle birleştirerek, müşteri beklentilerini aşan olağanüstü sonuçlar sunuyoruz.', 5, true);
