...
import { createProject, getServiceCategories } from "@/lib/supabase"
...
export default function NewProject() {
  ...
  // Services'den kategorileri yükle
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Yeni Proje Ekle</h1>
            <p className="text-gray-600 dark:text-gray-400">Yeni bir proje oluşturun</p>
          </div>
        </div>
