    ...
    "itemListElement": [
      {
        ...
        "item": {
          "@type": "Service",
          "name": "Taş Halı (Stone Carpet) Uygulaması",
          "url": "https://www.zeminustasi.com.tr/hizmetler/tas-hali",
          "description": "Doğal taş granülleri ile estetik ve dayanıklı zemin kaplama çözümü."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          "@type": "Service",
          "name": "Mikro Beton Uygulaması",
          "url": "https://www.zeminustasi.com.tr/hizmetler/mikro-beton",
          "description": "Minimalist ve modern görünümlü, ince katmanlı beton zemin çözümü."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          "@type": "Service",
          "name": "Epoksi Zemin Uygulaması",
          "url": "https://www.zeminustasi.com.tr/hizmetler/epoksi-zemin",
          "description": "Kimyasal ve mekanik dayanıklılığa sahip endüstriyel ve dekoratif zemin çözümleri."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          "@type": "Service",
          "name": "Kauçuk Zemin Kaplama",
          "url": "https://www.zeminustasi.com.tr/hizmetler/kaucuk-zemin",
          "description": "Güvenli ve esnek, darbe emici kauçuk zemin sistemleri."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          "@type": "Service",
          "name": "Spor Zemin Sistemleri",
          "url": "https://www.zeminustasi.com.tr/hizmetler/spor-zemin",
          "description": "Basketbol, voleybol gibi spor alanları için profesyonel zemin çözümleri."
        }
      }
    ]
  }
...
export default async function ServicesPage() {
  ...
  return (
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /><div className="flex min-h-screen flex-col bg-[#1a1a1a]">
        {/* Hero Section */}
